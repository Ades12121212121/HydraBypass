...
async function checkLicense() {
  // HYDRA BYPASS: Siempre crear la aplicación sin verificar licencia
  console.log("🐉 HYDRA BYPASS: Iniciando aplicación sin verificación de licencia");
  
  // Inicializar el gestionnaire de licence s'il n'existe pas déjà
  if (!licenseManager) {
    licenseManager = new LicenseManager();
  }
  
  // Bypass completo - crear la aplicación directamente
  createSelectionWindow();
  createApplicationMenu();
  setupIPCHandlers();
  
  console.log("✅ HYDRA BYPASS COMPLETO: Aplicación iniciada exitosamente");
}
